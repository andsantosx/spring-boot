...
2.  Execute o comando do Gradle Wrapper para iniciar a aplicação:

    ```sh
    ./gradlew bootRun
    ```

3.  A aplicação iniciará com o perfil de **desenvolvimento (`dev`)** por padrão, rodando na porta **`8081`** e conectando-se ao banco de dados `spring_boot`.
...
-   **Acesse a URL no seu navegador:** [**http://localhost:8081/api-docs**](http://localhost:8081/api-docs)
